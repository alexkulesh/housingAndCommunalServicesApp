...
import by.grodno.pvt.site.webappsample.exception.WorkerNotFoundException;
import by.grodno.pvt.site.webappsample.repo.UserRepo;
import by.grodno.pvt.site.webappsample.repo.WorkersRepo;
...
public class JPAWorkerService implements WorkerService, InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        User user = new User(null, "John", "Grey", "+375336000100", "naum@gmail.com", new Date(), null, UserRole.WORKER,  null);
